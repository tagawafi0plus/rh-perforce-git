...
namespace SocialGame.Internal.Sound
{
    ...
    {
        public SoundSettings _general = null;

        public BGMSettings _bgm = null;
		
        public SESettings _se = null;
		
        public VoiceSettings _voice = null;
        ...
        private void Generate(string type, IEnumerable<AudioClip> clips)
        {
            ...
            using (StreamWriter writer = new StreamWriter(path, false, Encoding.UTF8))
            {
                ...
                {
                    writer.WriteLine(string.Format("        {0},", clip.name.Replace(' ', '_')));
                }
